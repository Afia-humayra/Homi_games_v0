...
while True:
    ...
    if not game_over:
        cv2.putText(frame, f"Target: {target_color}", (10, 50),
                    cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
        cv2.putText(frame, f"Detected: {detected_color}", (10, 100),
                    cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
        cv2.putText(frame, f"Score: {score}", (10, 150),
                    cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 0), 2)

        if detected_color == target_color:
            cv2.putText(frame, "Right!", (10, 200),
                        cv2.FONT_HERSHEY_SIMPLEX, 1.2, (0, 255, 0), 3)
        else:
            cv2.putText(frame, "Try Again!", (10, 200),
        ...
        cv2.putText(frame, "  WELL DONE!", (width // 4, height // 2),
